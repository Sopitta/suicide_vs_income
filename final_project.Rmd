...
- Hierarchical model with uncorrelated $\alpha$ and $\beta$ (Figure 1)
- Hierarchical model with correlated $\alpha$ and $\beta$. (Figure 2)
- Separate model (Figure 3)
- Pooled model (Figure 3)
